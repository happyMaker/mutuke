...
class MainWindow:
	def __init__(self):
		...
		self.hwnd = win32gui.CreateWindow( wc.lpszClassName, u"沐图客", style, \
	...
	def _DoCreateIcons(self):
		...
		nid = (self.hwnd, 0, flags, win32con.WM_USER+20, hicon, u"沐图客")
		try:
			win32gui.Shell_NotifyIcon(win32gui.NIM_ADD, nid)
			win32gui.Shell_NotifyIcon(win32gui.NIM_MODIFY, \
                         (self.hwnd, 0, win32gui.NIF_INFO, win32con.WM_USER+20,\
                          hicon, "Balloon  tooltip",u"沐图客为您护航",200,u"沐图客"))
	...
	def OnTaskbarNotify(self, hwnd, msg, wparam, lparam):
		if lparam==win32con.WM_LBUTTONUP:
			...
			win32gui.AppendMenu( menu, win32con.MF_STRING, 1023, u"关于沐图客")
			#win32gui.AppendMenu( menu, win32con.MF_STRING, 1024, "Say Hello")
			win32gui.AppendMenu( menu, win32con.MF_STRING, 1025, u"退出" )
